...
public class EnemyClass3{
	...
	public EnemyClass3(List<Entry<Integer,Integer>>logpos , Bitmap sprite , Bitmap ob,float x,float y,String enemyDirection,int xSpeed,int ySpeed, PlayerClass player2){
		this.x = 15*(AllResources.targetWidth/480.0f);
		this.y = 665*(AllResources.targetHeight/800.0f);
