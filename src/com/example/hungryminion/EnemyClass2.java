...
public class EnemyClass2{
	...
	public EnemyClass2(List<Entry<Integer,Integer>>logpos , Bitmap sprite , Bitmap ob,float x,float y,String enemyDirection,int xSpeed,int ySpeed, PlayerClass player2){
		this.x = 337*(AllResources.targetWidth/480.0f);
		this.y = 570*(AllResources.targetHeight/800.0f);
