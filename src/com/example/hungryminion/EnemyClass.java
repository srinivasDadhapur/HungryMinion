...
public class EnemyClass{
	...
	public EnemyClass(List<Entry<Integer,Integer>>logpos , Bitmap sprite , Bitmap ob,float x,float y,String enemyDirection,int xSpeed,int ySpeed, PlayerClass player2){
		this.x = 268*(AllResources.targetWidth/480.0f);
		this.y = 216*(AllResources.targetHeight/800.0f);
